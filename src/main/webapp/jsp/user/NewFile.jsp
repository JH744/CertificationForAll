...
<body>
    ...
    <main id="main" class="main">
        <nav id="sideBar" class="sideBar" >
            ...
            <ul>
                <li class="s_menu">내 정보수정</a></li>
                <li class="s_menu">위시리스트</a></li>
                <li class="s_menu">내 문의</a></li>
                <li class="s_menu">스터디작성글</a></li>
             </ul>
        </nav>
        <article class="article" id="article">
             <section class="myPage">
                ...
                <div class="myRating">
                    <ul>
                        <li class="myname" id="myname">홍길동님</li>
                        <li>현재 회원님은 일반 회원등급입니다.</li>
                    </ul>
                    <img src="mypagelmg.png" class="mypageimg">
                </div>
                <!-- <div class="line1" ></div>
                ...
                <div class="container">
                    ...
                    <div class="box">
                        ...
                        <div class="b1">
                                ...
                                <li class="itemN">3건</li>
                        </div>
                        <A href="#" class="more" id="more1">더보기</A>
                    </div>
                    ...
                    <div class="box">
                        ...
                        <A href="#" class="more" id="more2">더보기</A>
                    </div>
                    ...
                    <div class="box">
                        ...
                        <A href="#" class="more" id="more3">더보기</A>
                    </div>
