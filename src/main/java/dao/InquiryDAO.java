...
public class InquiryDAO {
	...
	// 문의답변 삭제
	public InquiryVO inquiryAnswerDelete(int i_id) {
		InquiryVO vo = new InquiryVO();
		String sql = "update inquiry set " + "i_answer=? ," + "i_answerDate=null, " + "i_state=N " + "where i_id=?";
	...
	public InquiryVO inquiryAnswer(int i_id, String i_answer) {
		InquiryVO vo = new InquiryVO();
		String sql = "update inquiry set " + "i_answer=? ," + "i_answerDate=sysdate, " + "i_state=Y " + "where i_id=?";
